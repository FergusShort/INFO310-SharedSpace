...
('ABCD', 200.00, 150.00, 50.00, '2025-04-20',  'P', 'Electricity', TRUE, 30, FALSE, 'Monthly electricity bill'),
('ABCD', 150.00, 75.00, 75.00, '2025-04-22', 'P', 'Internet', FALSE, NULL, FALSE, 'Internet service provider bill');
...
('WXYZ', 'not-so-urgent', 'Wash Dishes', 'Wash all dishes from the sink');
